"! @testing BDEF:ZRAP100_R_TravelTP_000
CLASS zrap100_tc_travel_eml_000 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS ZRAP100_TC_TRAVEL_EML_000 IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                                i_for_entities = VALUE #( ( i_for_entity = 'ZRAP100_R_TravelTP_000' ) ) ).
    ...
    customer_mock_data = VALUE #( ( customer_id = '000092' last_name = 'Customer 000093' ) ).
  ...
  METHOD create_with_action.
    ...
    SELECT * FROM ZRAP100_R_TravelTP_000 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
