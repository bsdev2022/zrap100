...
*  ENDMETHOD.
  ...
  METHOD copyTravel.
    ...
    DATA: travels TYPE TABLE FOR CREATE ZRAP100_R_TravelTP_000\\travel.

    " remove travel instances with intial %cid (i.e., not set by caller API)
    ...
    LOOP AT travel_read_result ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      " adjust the coped travel instance data
      " BeginData must be on or after system date
